...
do
    ...
    epi_file=${data_dir}/${sub}/${sub}.${epi}.nii
    anat_file=${data_dir}/${sub}/${sub}.${anat}.nii
    ...
    #configure proc.py output directory
    out_dir=${data_dir}/${sub}/proc_py                           
