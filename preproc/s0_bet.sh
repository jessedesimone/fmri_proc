...
infile=${out_dir}/${sub}/${sub}.${anat}.nii - deobliqued and resampled T1 output image from s0_deoblique.sh
outfile=${out_dir}/${sub}/${sub}.${anat}2.nii.gz - skullstrip/brain extract T1
'
